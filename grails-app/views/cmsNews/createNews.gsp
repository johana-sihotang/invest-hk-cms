<%--
  ...
  Time: 10:40
--%>
<div class ="grid grid-flow-col justify-items-center bg-sky-400">
...
<g:form controller="cmsNews" action="save" method="POST" enctype="multipart/form-data">
    <div class="grid gap-6 mb-6 md:grid-cols-2">
        ...
        <div>
            <label for="article_title" class="block mb-2 text-sm font-bold text-gray-900">Title</label>
        ...
        <div>
            <label for="subTitle" class="block mb-2 text-sm font-bold text-gray-900">Sub Title</label>
    ...
    <div class="flex gap-6 flex-col">
        ...
        <div>
            <label for="imageCaption" class="block mb-2 text-sm font-bold text-gray-900">Image Caption</label>
    ...
    <div class="flex gap-5 ">
        <button type="submit"
                class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-boldrounded-lg text-sm w-full sm:w-auto px-5 py-2.5 mt-5 text-center">Submit
        </button>
        <g:link controller="cmsNews" action="index" class="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-boldrounded-lg text-sm w-full sm:w-auto px-5 py-2.5 mt-5 text-center">
            Cancel
        </g:link>
    </div>
</g:form>
