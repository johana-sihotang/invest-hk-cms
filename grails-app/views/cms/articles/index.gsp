                ...
                >
                    <li class="nav-item menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <g:link controller="articles" action="article" namespace="cms" class="nav-link">
    ...
    <main class="app-main">
        ...
        <div class="app-content-header">
            ...
            <div class="container-fluid">
                <!--begin::Row-->
                <div class="row">
                    <div class="col-sm-6"><h3 class="mb-0">Invest HK</h3></div>
                    <div class="col-sm-6">
...
<asset:javascript src="/adminlte/adminlte.js"/>
